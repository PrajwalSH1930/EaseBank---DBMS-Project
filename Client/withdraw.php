...
<head>
    ...
    <title>EaseBank &mdash; Withdraw</title>
...
<body>
    <div class="container">
            ...
            if(isset($_POST['withdraw'])){
                ...
                if($pin==$pwd){
                    if($TotalBalInAccount>$tr_amt){
                        $tr_type = 'Withdraw';
                        $message = "A/c $acc_num Debited for Rs.$tr_amt on $date by Withdrawal ref no .$tr_code -EaseBank";
                        ...
                        <p>A/c $acc_num Debited for Rs.$tr_amt on $date by Withdrawal ref no $tr_code -EaseBank.</p>
                        </div>";
                    }else{
        ...
        ?>
            <h2 class="secondary_head">Withdraw Money</h2>
            <form method="post" onclick="openPinModel()" autocomplete="off">
                <div class="grid-3-cols">
                    <div class="transfer_div">
                        <label for="">Client Name</label>
                        <input type="text" readonly name="name" value="<?php echo $acc_name?>" required
                            class="readonly">
                    </div>
                    <div class="transfer_div">
                ...
                <div class="grid-2-cols">
                    <div class="transfer_div">
                        ...
                        <input type="text" readonly required name="acc_num" value="<?php echo $acc_num?>"
                            class="readonly">
                    </div>
                    <div class="transfer_div">
                ...
                <button type="submit" name="withdrawBtn" class="transfer_btn">Withdraw
                    Funds</button>
                <div class="pinForm">
